...
/**
 * Lista genérica Implementación de una lista enlazada.
 *
 ...
 *
 * @param <T>
 *            Objetos de los que constará la lista
 *
 */
public class Lista<T> {
	 ...
	 *
	 * @param valor
	 *            Valor que se almacenará en la lista
	 */
	 ...
	 *
	 * @param valor
	 *            Valor a buscar en la lista
	 * @return true si el valor se encuentra en la lista, si no se encuentra retorna
	 *         false
	 */
